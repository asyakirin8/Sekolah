        ...
        <div class="flex items-center flex-col md:flex-row gap-10">
          ...
          <div class="flex-1 text-center md:text-left items-center">
            ...
            <button
              ...
              class="mt-5 w-fit rounded-lg flex justify-center items-center h-fit text-sm px-8 py-2.5 text-white bg-[#063F38] hover:bg-[#063F38]/90 disabled:bg-[#F3586A]/30 disabled:text-[#F3586A]/50 disabled:border-primary/5 disabled:cursor-default"
            >
              Back to Home
            </button>
          </div>

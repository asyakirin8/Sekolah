...
export default defineNuxtConfig({
  runtimeConfig: {
    ...
    aws: {
      ...
      secretKeyAccess: process.env.NUXT_AWS_SECRET_ACCESS_KEY,
      s3Region: process.env.NUXT_AWS_REGION,
      s3Bucket: process.env.NUXT_AWS_BUCKET,
      s3BucketURL: process.env.NUXT_AWS_BUCKET_URL,
    },
    public: {
      env: process.env.NUXT_ENV,
      feURL: process.env.NUXT_FE_URL,
      bankURL: process.env.NUXT_TYP_FPX_BANK_URL,
      typbankURL: process.env.NUXT_TYP_BANK_URL,
      s3URL: process.env.NUXT_AWS_BUCKET_URL,
    },
  },
  modules: [
    "@nuxtjs/tailwindcss",
  ...
  multiTenancy: {
    ...
    rootDomains: ["jayyid.local", "jayyid.co"],
  },
  app: {
